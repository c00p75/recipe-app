  ...
  def index
    ...
    recipes.each do |recipe|
      ...
      recipe_food_quantities.each do |food_id, quantity|
        ...
        if food.quantity < quantity # if the available food amount is less than required amount
          required_quantity = quantity - food.quantity # set the food quantity to the difference
          shopping_list_item = { food: food, quantity: required_quantity } # create a hash with the food and the quantity
